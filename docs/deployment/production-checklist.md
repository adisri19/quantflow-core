...
description: "Preflight checks before running quantflow in production"
...
Use this checklist before exposing a quantflow deployment to users or real broker credentials.

## Identity And Access

- Configure `QUANTFLOW_ADMIN_EMAIL` and `QUANTFLOW_ADMIN_PASSWORD`; public registration is disabled.
