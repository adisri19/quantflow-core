...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="QuantFlow.Sdk" Version="0.1.2" />
  </ItemGroup>

</Project>
```

The SDK is published on NuGet as `QuantFlow.Sdk`. Install it with:

```bash
dotnet add package QuantFlow.Sdk
```
...
client.DefaultRequestHeaders.Add("User-Agent", "quantflow-sma-bot/1.0");
