---
title: "Deployment"
description: "Deploy custom bots to quantflow platform"
...
Create a `.quantflowignore` file to exclude files from deployment. This works like .gitignore:
...
- [Bot Commands](/quantflow-cli/bot-commands) - Managing bot instances
