...
description: "Build your first Node.js or TypeScript trading bot with quantflow"
...
```json
{
  ...
  "dependencies": {
    "@quantflow-io/quantflow-node": "^0.1.0",
    "pino": "^9.0.0"
  },
  "devDependencies": {
    "typescript": "^5.3.0",
...
```bash
# Configure npm for the @quantflow-io scope
echo "@quantflow-io:registry=https://npm.pkg.github.com" >> ~/.npmrc
...
```typescript
import { parse, metric, sleep, success } from "@quantflow-io/quantflow-node";
...
```typescript
import { parse } from "@quantflow-io/quantflow-node";
...
```typescript
import { metric } from "@quantflow-io/quantflow-node";
...
```typescript
import { sleep } from "@quantflow-io/quantflow-node";
...
```typescript
import { success } from "@quantflow-io/quantflow-node";
...
```typescript
import { error } from "@quantflow-io/quantflow-node";
...
```javascript
import { parse, metric, sleep } from "@quantflow-io/quantflow-node";
