...
description: "Build your first Python trading bot with quantflow"
...
import random
import logging
from quantflow import parse, success, error, metric
...
def main(bot_id: str = None, config: dict = None):
    """Bot entry point using quantflow SDK."""
