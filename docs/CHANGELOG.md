...
- **Haskell Quick Start Guide** - Complete guide for building Haskell trading bots with quantflow SDK
  - SDK installation and usage with `QuantFlow.Input` module
  - Project structure and Cabal configuration examples
  - Best practices for error handling, validation, and logging
- **Scala Quick Start Guide** - Complete guide for building Scala 3 trading bots with quantflow SDK
  - SDK installation and usage with `quantflow.Input` object
  - SBT project structure and configuration examples
  - Best practices for error handling, async programming, and logging
- **C/C++ Quick Start Guide** - Complete guide for building C/C++ trading bots with quantflow
  - SDK installation and usage with `quantflow.h` header-only library
  - CMake and Makefile project setup examples
  - Best practices for error handling, memory safety, and logging
- **C# Quick Start Guide** - Complete guide for building C# trading bots with quantflow SDK
  - SDK installation and usage with `QuantFlow.Input` class
  - Project structure and .NET 8 configuration examples
  - Best practices for error handling, async programming, and logging
- **Rust Quick Start Guide** - Complete guide for building Rust trading bots with quantflow SDK
  - SDK installation and usage with `quantflow::input` module
...
- Custom theme with quantflow brand colors
