...
describe("BotEventsContext", () => {
  beforeEach(() => {
    ...
    if (typeof window !== "undefined") {
      delete (window as any).__QUANTFLOW_EVENTS_CONTEXT__;
    }
  });
  ...
  describe("useQuantFlowEvents (alias)", () => {
    it("is an alias for useBotEventsContext", () => {
      ...
      const { result: result2 } = renderHook(() => useQuantFlowEvents(), {
        wrapper,
      });
