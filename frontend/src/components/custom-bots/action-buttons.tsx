...
export const ActionButtons: React.FC<ActionButtonsProps> = ({
  ...
  const deployCommand = `quantflow bot deploy config.json`;
      ...
      <Dialog open={isDeployModalOpen} onOpenChange={setIsDeployModalOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Use the quantflow CLI to deploy your bot as a running instance.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Run this command in your terminal where the quantflow CLI is
                installed.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2 text-xs font-mono bg-muted p-4 rounded-lg">
                ...
                <p>
                  quantflow custom-bot schema bot {selectedVersion} {bot.name}
                </p>
