...
if (typeof window !== "undefined") {
  (window as any).__QUANTFLOW_REACT__ = React;
  (window as any).__QUANTFLOW_REACT_DOM__ = ReactDOM;
  (window as any).__QUANTFLOW_REACT_JSX__ = ReactJSXRuntime;
}
...
export const BotDashboardLoader = React.memo(function BotDashboardLoader({
  ...
  useEffect(() => {
    ...
    const cacheKey = version ? `quantflow-bundle-${customBotId}-${version}` : null;
