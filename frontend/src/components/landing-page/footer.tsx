...
const footerLinks = {
  ...
  Resources: [
    { name: "Docs", href: "/docs" },
    { name: "GitHub", href: "https://github.com/quantflow-io/quantflow" },
  ],
        ...
        <div className="mt-12 pt-8 border-t">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold ml-2">quantflow</span>
            </div>

            <div className="flex items-center space-x-4">
              <Button variant="ghost" size="icon" asChild>
                <a
                  href="https://github.com/quantflow-io/quantflow"
                  target="_blank"
            ...
            <p className="text-sm text-muted-foreground text-center md:text-right">
              © {new Date().getFullYear()} quantflow. Open source under Apache 2.0.
            </p>
          </div>
        </div>
      </div>
