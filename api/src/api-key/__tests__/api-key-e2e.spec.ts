...
describe("ApiKeyController (e2e)", () => {
  ...
  const mockApiKey = {
    ...
    name: "Test API Key",
    keyValue:
      "quantflow_1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
    key: "quantflow_1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  };
  ...
  it("/api-keys (POST) should create API key", async () => {
    return request(app.getHttpServer())
      ...
      .expect((res) => {
        ...
        expect(res.body.key).toMatch(/^quantflow_[a-f0-9]{64}$/);
  ...
  it("/api-keys (GET) should return user API keys", async () => {
    ...
    return request(app.getHttpServer())
      ...
      .expect((res) => {
        ...
        expect(res.body[0].key).toMatch(/^quantflow_[a-f0-9]{64}$/);
