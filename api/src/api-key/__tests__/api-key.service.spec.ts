...
describe("ApiKeyService", () => {
  ...
  const mockApiKey = {
    ...
    userId: "user-123",
    name: "Test API Key",
    key: "quantflow_abcdef123456789abcdef123456789abcdef123456789abcdef123456789",
    isActive: true,
    createdAt: new Date(),
    updatedAt: new Date(),
  };
  ...
  describe("createApiKey", () => {
    it("should create an API key successfully", async () => {
      ...
      expect(result.data.key).toBe(
        "quantflow_abcdef123456789abcdef123456789abcdef123456789abcdef123456789",
      );
  ...
  describe("validateApiKey", () => {
    it("should validate API key and update last used", async () => {
      ...
      const result = await service.validateApiKey("quantflow_abcdef123456789");
