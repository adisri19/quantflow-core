...
A Python FastAPI service powered by Google's ADK framework, running Gemini 2.5 Flash with Tavily web search. It lived in `services/quantflow-ai/` and had dreams of helping developers build trading bots through natural conversation.
...
Per [Issue #62](https://github.com/quantflow-io/quantflow/issues/62):
