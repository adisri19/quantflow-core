...
const UniversalRuntimeImage = "ghcr.io/quantflow-io/quantflow/runtime:latest"

// supportedRuntimes lists all valid runtime identifiers.
// All runtimes use the universal image (quantflow/runtime:latest).
...
// All runtimes use the universal image (quantflow/runtime:latest) which contains all language runtimes.
