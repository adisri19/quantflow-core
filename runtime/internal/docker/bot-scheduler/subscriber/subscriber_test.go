...
func TestConstants(t *testing.T) {
	assert.Equal(t, "quantflow.bot-schedule.created", SubjectBotScheduleCreated)
	assert.Equal(t, "quantflow.bot-schedule.updated", SubjectBotScheduleUpdated)
	assert.Equal(t, "quantflow.bot-schedule.deleted", SubjectBotScheduleDeleted)
}
