...
const (
	SubjectBotScheduleCreated = "quantflow.bot-schedule.created"
	SubjectBotScheduleUpdated = "quantflow.bot-schedule.updated"
	SubjectBotScheduleDeleted = "quantflow.bot-schedule.deleted"
)
