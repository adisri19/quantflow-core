...
type DockerRunnerConfig struct {
	...
	DockerNetwork           string // Docker network to connect containers to (e.g., "quantflow-oss-network")
...
// DOCKER_NETWORK (optional: Docker network for bot containers, e.g., "quantflow-oss-network")
