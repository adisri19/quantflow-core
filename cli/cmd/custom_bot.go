...
func NewCustomBotCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long:  "Deploy, update, and manage your custom trading bots on quantflow platform",
	}
...
func NewDeployCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "deploy",
		Short: "Deploy your bot to quantflow platform",
		Long:  "Deploy your trading bot to quantflow platform",
		Run:   deployBot,
	}
}
...
func listCustomBots(cmd *cobra.Command, args []string) {
	...
	if len(customBots) == 0 {
		...
		logger.Print("Deploy your first bot with 'quantflow custom-bot deploy'")
		return
	}
