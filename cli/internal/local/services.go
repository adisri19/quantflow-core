...
var ServiceRegistry = map[string]ServiceInfo{
	...
	"frontend": {
		ComposeService: "quantflow-frontend",
	...
	"postgres": {
		...
		Port:           5432,
		URL:            "postgresql://quantflow:quantflow_password@localhost:5432/quantflow_oss",
		Category:       "infra",
	},
	"mongo": {
		...
		Port:           27017,
		URL:            "mongodb://root:quantflow_mongo_password@localhost:27017",
		Category:       "infra",
	},
	"nats": {
		ComposeService: "nats",
...
// Accepts both friendly names ("api") and compose service names ("quantflow-api").
