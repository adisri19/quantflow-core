...
func main() {
	var rootCmd = &cobra.Command{
		Use:   "quantflow",
		Short: "quantflow CLI - Deploy and manage your trading bots",
		Long: `
 _____ _          ___
|_   _| |_  ___  / _ \
  | | | ' \/ -_)| (_) |
...
func startupVersionCheck() {
	...
	if isNewer {
		fmt.Fprintf(os.Stderr,
			"A new version of quantflow CLI is available: %s (current: %s). Run 'quantflow update' to upgrade.\n",
