# quantflow-sdk (Python)

SDK for building trading bots on quantflow platform.

## Installation

```bash
pip install quantflow-sdk
```

Or copy the `quantflow/` directory to your project.

## Quick Start

```python
from quantflow import parse, success, error, metric, log
