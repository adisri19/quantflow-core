"""
quantflow Query Module - Express-like handler interface for bot queries.
...
Separate namespace from state and main SDK. Users explicitly import:
    from quantflow import query
    from quantflow import state  # If needed in handlers
...
def run():
    ...
    Environment Variables:
        ...
        QUANTFLOW_QUERY_PORT: HTTP server port (default: 9476)
...
def _run_server():
    ...
    port = int(os.environ.get("QUANTFLOW_QUERY_PORT", "9476"))
