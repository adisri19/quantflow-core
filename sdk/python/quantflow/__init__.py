"""
quantflow SDK for Python Trading Bots
================================

This SDK provides utilities for building trading bots on quantflow platform.
...
# Import state module for namespace access (e.g., quantflow.state.get())
from . import state

# Import query module for namespace access (e.g., quantflow.query.handler())
from . import query
