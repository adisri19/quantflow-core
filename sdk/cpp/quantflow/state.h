/**
 * quantflow State Module for C/C++
 *
 ...
 *   int main() {
 *       // Store state
 *       quantflow::state::set("portfolio", {{"AAPL", 100}, {"GOOGL", 50}});
 *
 *       // Retrieve state
...
#ifndef QUANTFLOW_STATE_H
#define QUANTFLOW_STATE_H
...
inline std::string get_state_dir() {
    ...
    return dir ? std::string(dir) : "/state/.quantflow-state";
}
 ...
 * @example
 *   quantflow::state::set("portfolio", {{"AAPL", 100}, {"GOOGL", 50}});
 *   quantflow::state::set("trade_count", 42);
 */
 ...
 *
 * @example
 *   if (quantflow::state::remove("old_data")) {
