/**
 * quantflow SDK for C/C++ trading bots
 *
 * This is a header-only library for building trading bots on quantflow platform.
 ...
 *   quantflow::log("Starting trade execution");
 *
 *   // Log with level
 *   quantflow::log("Connection lost", {}, LogLevel::Warn);
 *
 *   // Log with structured data
 *   quantflow::log("Order placed", {{"order_id", "12345"}, {"symbol", "BTC/USD"}});
 *
 *   // Log with data and level
 *   quantflow::log("Order failed", {{"order_id", "12345"}}, LogLevel::Error);
 *
