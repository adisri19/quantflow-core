/**
 * Test utilities for quantflow C++ SDK tests
 */

#ifndef QUANTFLOW_TEST_HELPERS_HPP
#define QUANTFLOW_TEST_HELPERS_HPP
...
public:
    ResultFileContext() {
        ...
        temp_dir_ = std::filesystem::temp_directory_path() / ("quantflow_test_" + std::to_string(rand()));
        std::filesystem::create_directories(temp_dir_);

        // Set environment variable (quantflow SDK reads CODE_MOUNT_DIR)
...
#endif // QUANTFLOW_TEST_HELPERS_HPP
