# @quantflow-io/quantflow-react

React SDK for building custom bot dashboards on quantflow platform.
...
```bash
npm install @quantflow-io/quantflow-react
# or
yarn add @quantflow-io/quantflow-react
```

## Usage

```tsx
import { useQuantFlowEvents } from '@quantflow-io/quantflow-react';
