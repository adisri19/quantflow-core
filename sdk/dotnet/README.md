...
Optional SDK for building trading bots on quantflow platform using C#/.NET 8.
...
The SDK reads from these environment variables (set automatically by quantflow runtime):
