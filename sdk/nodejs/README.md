# @quantflow-io/quantflow-node

Official SDK for building trading bots on quantflow platform with Node.js and TypeScript.

## Installation

This package is published to GitHub Packages. First, configure npm to use GitHub Packages for the `@quantflow-io` scope:
...
```bash
npm install @quantflow-io/quantflow-node
# or
yarn add @quantflow-io/quantflow-node
```

## Quick Start

```typescript
import { parse, success, error, metric } from '@quantflow-io/quantflow-node';
...
```typescript
import { parse, success, error } from '@quantflow-io/quantflow-node';
