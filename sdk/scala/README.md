...
SDK for building trading bots on quantflow platform in Scala 3.
...
lazy val quantflowSdk = RootProject(uri("https://github.com/quantflow-io/quantflow.git#v1.1.0") / "sdk" / "scala")

lazy val root = (project in file("."))
  .dependsOn(quantflowSdk)
```
...
Copy `src/main/scala/quantflow/Input.scala` to your project's source directory.
