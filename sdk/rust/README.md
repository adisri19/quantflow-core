...
Optional SDK for building trading bots on quantflow platform.

**Note:** This SDK is optional. The quantflow runtime automatically wraps your bot's output:
...
```toml
[dependencies]
quantflow-sdk = { git = "https://github.com/quantflow-io/quantflow", subdirectory = "sdk/rust" }
```
...
See the [Rust Quick Start Guide](https://docs.quantflow.io/custom-bot-development/rust-quick-start) for a complete example.
