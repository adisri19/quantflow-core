# quantflow-sdk (Haskell)

This SDK provides utilities for building trading bots on quantflow platform using Haskell.
...
```cabal
build-depends: quantflow-sdk
```

> **Note:** Check [releases](https://github.com/quantflow-io/quantflow/releases) for the latest version tag.

### Option 2: Copy the Package

Copy `src/QuantFlow/Input.hs` to your project's source directory.
...
main = do
    ...
    case symbol of
        ...
        _ -> QuantFlow.Input.error "Missing symbol configuration"
```
...
# Add quantflow SDK as a dependency in your .cabal file
