...
-- |
-- Module      : QuantFlow.Input
-- Description : Input parsing and output formatting for quantflow trading bots
-- License     : Apache-2.0
--
-- This module provides utilities for building trading bots on quantflow platform.
--
-- = Example
--
-- @
...
logInfo msg mData = QuantFlow.Input.log msg mData (Just Info)

-- | Convenience function: log a warning message
logWarn :: String -> Maybe Value -> IO ()
logWarn msg mData = QuantFlow.Input.log msg mData (Just Warn)

-- | Convenience function: log an error message
logError :: String -> Maybe Value -> IO ()
logError msg mData = QuantFlow.Input.log msg mData (Just Error)
