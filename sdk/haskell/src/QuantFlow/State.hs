...
-- |
-- Module      : QuantFlow.State
-- Description : Persistent state management for quantflow trading bots
-- License     : Apache-2.0
--
...
getStateDir = fromMaybe "/state/.quantflow-state" <$> lookupEnv "STATE_DIR"
