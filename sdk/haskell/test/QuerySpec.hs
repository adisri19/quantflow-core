...
import Test.Hspec
import QuantFlow.Query as Query
...
withTempEnv action = withSystemTempDirectory "quantflow-query-test" $ \tempDir -> do
...
spec :: Spec
spec = do
    describe "QuantFlow.Query.isQueryMode" $ do
    ...
    describe "QuantFlow.Query.getParam" $ do
    ...
    describe "QuantFlow.Query.Request" $ do
    ...
    describe "QuantFlow.Query.ReadOnlyStateError" $ do
