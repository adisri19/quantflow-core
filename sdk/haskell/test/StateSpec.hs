...
import Test.Hspec
import QuantFlow.State as State
...
withTempStateDir action = withSystemTempDirectory "quantflow-state-test" $ \tempDir -> do
...
spec :: Spec
spec = do
    describe "QuantFlow.State.set and get" $ do
    ...
    describe "QuantFlow.State.get with defaults" $ do
    ...
    describe "QuantFlow.State.exists" $ do
    ...
    describe "QuantFlow.State.delete" $ do
    ...
    describe "QuantFlow.State.list" $ do
    ...
    describe "QuantFlow.State.clear" $ do
    ...
    describe "QuantFlow.State key validation" $ do
    ...
    describe "QuantFlow.State complex data" $ do
